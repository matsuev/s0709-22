...
const (
	TestService_Echo_FullMethodName = "/demo.service.proto.TestService/Echo"
)
...
func (c *testServiceClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoRequest, error) {
...
func (UnimplementedTestServiceServer) Echo(context.Context, *EchoRequest) (*EchoRequest, error) {
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "demo.service.proto.TestService",
