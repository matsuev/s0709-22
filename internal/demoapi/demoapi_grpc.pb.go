...
func (c *demoServiceClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoRequest, error) {
...
func (UnimplementedDemoServiceServer) Echo(context.Context, *EchoRequest) (*EchoRequest, error) {
